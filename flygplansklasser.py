class Aircraft:
    def __init__(self, weight, ref_area, cruise_speed, climb_speed, descent_speed, takeoff_speed,climb_angle, cruise_angle, descent_angle, propeller_efficiency, runway_length):
        self.weight = weight
